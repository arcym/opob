...
//todo: make a build:scripts, and link watch:scripts to it
//todo: delete anything before you build it
...
gulp.task("watch:scripts", function() {
    var ifying = watchify(browserify(watchify.args))
